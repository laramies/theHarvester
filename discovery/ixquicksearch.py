...
# https://ixquick.com/do/search?query="microsoft.com")
...
class search_ixquick:
    ...
    def do_search_profiles(self):
        r = requests.get(
            "https://" + self.hostname + '/do/search?query=site:www.google.com%20intitle:"Google%20Profile"%20"Companies%20I%27ve%20worked%20for"%20"at%20' + self.word)
        returncode = r.status_code
        headers = r.headers
        self.results = r.text
        self.totalresults += self.results
