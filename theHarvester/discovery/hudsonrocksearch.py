...
class SearchHudsonRock:
    ...
    async def do_search(self) -> None:
        ...
        self.logger.info(f'Hudson Rock search completed. Found {len(self.totalhosts)} hosts, '
    ...
    def _process_domain_response(self, response: dict) -> None:
        ...
        try:
            ...
            self.logger.info(f'Domain statistics: {stats["total_compromised"]} total compromised, '
    ...
    def _process_email_response(self, response: dict) -> None:
        ...
        try:
            ...
            self.logger.info(f'Processed {len(stealers)} stealer records, '
                           f'extracted {len(self.totalips)} IPs')
    ...
    async def process(self, proxy: bool = False) -> None:
        ...
        try:
            ...
            self.logger.info(f'Hudson Rock processing completed successfully: '
