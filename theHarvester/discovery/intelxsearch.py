...
class SearchIntelx:
    ...
    async def do_search(self):
        try:
            ...
            r = await AsyncFetcher.post_fetch(url=f'{self.database}phonebook/search', headers=headers, data=data, json=True)
            uuid = r['id']
            ...
            r = await AsyncFetcher.fetch_all([url], headers=headers, json=True)
            r = r[0]
