...
### Added
- Added bounded recursive DNS discovery with three-vantage consensus, closest-encloser wildcard controls, exact-address PTR evidence, and explicit query, depth, runtime, and zero-yield limits.
