...
### Changed
- Replaced Shodan's synchronous Python SDK with direct async Host API requests, retaining every resolved IPv4, proxy support, cancellation, and existing persisted evidence without a source-local deadline.
