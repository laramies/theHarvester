...
What is this?
-------------
theHarvester is a very simple to use, yet effective tool designed to be used in the early statges of a<br>
penetration test or red team engagement. Use it for open source intelligence (OSINT) gathering to help<br>
determine a company's external threat landscape on the internet. The tool gathers emails, names, subdomains,<br>
IPs and URLs using multiple public data sources that include:
